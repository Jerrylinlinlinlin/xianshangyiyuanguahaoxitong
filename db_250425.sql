...
-- 正在导出表  xianshangyiyuanguahaoxitong.config 的数据：~2 rows (大约)
...
INSERT INTO `huiyuan` (`id`, `username`, `password`, `huiyuan_name`, `huiyuan_phone`, `huiyuan_id_number`, `huiyuan_photo`, `sex_types`, `huiyuan_email`, `new_money`, `huiyuan_content`, `create_time`) VALUES
	(1, 'user1', '123456', '李晓晴', '17703786901', '410224199610232001', 'http://localhost:8080/xianshangyiyuanguahaoxitong/upload/1745415996236.jpg', 2, 'lixiaoqing@qq.com', 99050.25, '会员介绍1', '2022-03-28 05:58:58'),
	...
	(3, 'user3', '123456', '叶小棠', '17703786903', '410224199610232003', 'http://localhost:8080/xianshangyiyuanguahaoxitong/upload/1745464901049.jpg', 2, 'yexiaotang@qq.com', 333.14, '<p>会员介绍31111</p>', '2022-03-28 05:58:58');
...
INSERT INTO `token` (`id`, `userid`, `username`, `tablename`, `role`, `token`, `addtime`, `expiratedtime`) VALUES
	(1, 6, 'admin', 'users', '管理员', '10lq6h25j1a9ueehgu1mcgwpjtu3y7cc', '2022-03-28 05:54:00', '2025-04-25 10:41:23'),
	...
	(4, 1, 'a1', 'zhuanjia', '医生', '5j28zbrhng56npxkw6al9b5z6i0xykuc', '2022-03-28 06:17:17', '2025-04-24 04:46:22'),
	(5, 1, 'a1', 'huiyuan', '用户', 'be6zjr08d2hzmra0ls9705unsig10q4p', '2022-04-06 07:34:00', '2025-04-25 10:41:11'),
	(6, 2, 'a2', 'huiyuan', '用户', 'h0othoeczrtze32kl7h2owwqkk61c8kr', '2022-04-06 07:34:23', '2025-04-24 04:44:58'),
	(7, 2, 'a2', 'zhuanjia', '医生', 'c4wm1ew7bvc2v83xq7pm8ca2j4xvxjjw', '2022-04-06 07:37:04', '2025-04-24 04:47:15'),
	(8, 3, 'a3', 'huiyuan', '用户', 'hiui6cywt0h49k0cfnj6mm1cz4edwfm5', '2025-04-22 02:59:45', '2025-04-24 04:45:31'),
	(9, 3, 'doctor3', 'zhuanjia', '医生', 'p62ydorz56rbctarrjkcvwev6v6cmhqw', '2025-04-24 03:04:15', '2025-04-24 04:47:37');
...
CREATE TABLE IF NOT EXISTS `zhuanjia_liuyan` (
  ...
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='医生留言';

-- 正在导出表  xianshangyiyuanguahaoxitong.zhuanjia_liuyan 的数据：~4 rows (大约)
INSERT INTO `zhuanjia_liuyan` (`id`, `zhuanjia_id`, `huiyuan_id`, `zhuanjia_liuyan_text`, `insert_time`, `reply_text`, `update_time`, `create_time`) VALUES
	(1, 3, 2, '张勇医术高', '2025-04-24 03:27:16', NULL, NULL, '2025-04-24 03:27:16'),
	(2, 2, 1, '梁医生，没胃口是肠胃出问题了吗', '2025-04-24 03:28:13', NULL, NULL, '2025-04-24 03:28:13'),
	(3, 1, 3, '李医生，你下周一上班吗', '2025-04-24 03:29:07', NULL, NULL, '2025-04-24 03:29:07');
...
CREATE TABLE IF NOT EXISTS `zhuanjia_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='医生挂号订单';

-- 正在导出表  xianshangyiyuanguahaoxitong.zhuanjia_order 的数据：~2 rows (大约)
INSERT INTO `zhuanjia_order` (`id`, `zhuanjia_order_uuid_number`, `zhuanjia_id`, `huiyuan_id`, `guahao_time`, `shijianduan_types`, `zhuanjia_order_yesno_types`, `zhuanjia_order_yesno_text`, `insert_time`, `create_time`) VALUES
	...
	(4, '1745476352976', 3, 1, '2025-04-24', 6, 1, NULL, '2025-04-24 06:32:33', '2025-04-24 06:32:33');

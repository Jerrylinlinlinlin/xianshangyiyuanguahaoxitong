...
import com.strategy.UpdateZhuanjiaLiuyanStrategy;
import com.strategy.ZhuanjiaLiuyanStrategy;
...
public class ZhuanjiaLiuyanController {
    ...
    */
    ...
    public R update(@RequestBody ZhuanjiaLiuyanEntity entity, HttpServletRequest request) { // 参数名正确为 entity
        ZhuanjiaLiuyanStrategy strategy = new UpdateZhuanjiaLiuyanStrategy(zhuanjiaLiuyanService);
        return strategy.execute(entity, request); // 正确使用参数 entity
    }
    /******************原方法******************/
//    @RequestMapping("/update")

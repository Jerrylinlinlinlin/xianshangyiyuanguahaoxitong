...
import com.factory.EntityViewFactoryProducer;
...
public class ZhuanjiaController {
    ...
    @Autowired
    private EntityViewFactoryProducer factoryProducer;
    ...
    */
    ...
    public R detail(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(zhuanjia !=null){
            /******************工厂模式（开始）******************/
            // 通过工厂生产类获取对应的实体转换工厂
            EntityViewFactory<ZhuanjiaEntity, ZhuanjiaView> factory = factoryProducer.getFactory(ZhuanjiaEntity.class);
            // 调用工厂的转换方法
            ZhuanjiaView view = factory.convertToView(zhuanjia, request);
            /******************工厂模式（结束）******************/
            /******************原方法（开始）******************/
//            //entity转view
//            ZhuanjiaView view = new ZhuanjiaView();
